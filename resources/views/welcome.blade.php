...
<html>
    <head>
      ...
      <link href="{{ secure_asset('css/gradients.css') }}" rel="stylesheet" type="text/css">
    ...
    <body class="">
        <div class="wrapper">
            ...
            <div class="message">
                <a class="twitter-link" href="http://twitter.com/home/?status=I%20created%20a%20project%20with%20AWS%20CodeStar!%20%23AWS%20%23AWSCodeStar%20https%3A%2F%2Faws.amazon.com%2Fcodestar"><img src="{{ secure_asset('img/tweet.svg') }}" /></a>
                <div class="text">
        ...
        <script type="text/javascript" src="{{ secure_asset('js/set-background.js') }}"></script>
    </body>
</html>
