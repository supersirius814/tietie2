...
exit;
		...
		*/
		...
		function dir_list_form() {
			...
			function unzip_form(){
				openModalWindow('".addslashes($fm_path_info["basename"])."?z=star','".et('Unzip')."');
			}
			function mysql_form(){
				openModalWindow('".addslashes($fm_path_info["basename"])."?m=star','".et('Mysql')."');
			}
			...
			<table class=\"table\">
				...
				<form action=\"".$fm_path_info["basename"]."\" method=\"post\" onsubmit=\"return test_action();\">
					<div class=\"float-left\">
						...
						<button type=\"button\" class=\"btn\" onclick=\"unzip_form()\" value=\"".et('Unzip')."\"><i class=\"fa fa-file-archive-o\"></i> ".et('Unzip')."</button>
						<button type=\"button\" class=\"btn\" onclick=\"mysql_form()\" value=\"".et('Mysql')."\"><i class=\"fa fa-database\"></i> ".et('Mysql')."</button>
					</div>
				</form>
				</nobr>
				</td>
